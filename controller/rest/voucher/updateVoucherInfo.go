...
// 请求
type updateVoucherInfoRequest struct {
...
// 方法
func UpdateVoucherInfo(c *gin.Context) {
	defer func() {
		if err := recover(); err != nil {
			c.JSON(http.StatusOK, model.Response{
				Code:    "voucher.UpdateVoucherInfo.ex",
	...
	//region 解析请求参数
	var request updateVoucherInfoRequest
	err := c.ShouldBindJSON(&request)
	if err != nil {
		c.JSON(http.StatusOK, model.Response{
			Code:    "voucher.UpdateVoucherInfo.request err",
	...
	if golibs.Length(request.voucherid) <= 0 {
		c.JSON(http.StatusOK, model.Response{
			Code:    "voucher.UpdateVoucherInfo.voucherid is null",
			Message: "缺少【抵用券ID】参数",
		})
		return
	}
	if !golibs.IsNumber(request.voucherid) {
		c.JSON(http.StatusOK, model.Response{
			Code:    "voucher.UpdateVoucherInfo.voucherid is number",
	...
	if err != nil {
		c.JSON(http.StatusOK, model.Response{
			Code:    "voucher.UpdateVoucherInfo.voucherid parse err",
	...
	if request.voucheridInt <= 0 {
		c.JSON(http.StatusOK, model.Response{
			Code:    "voucher.UpdateVoucherInfo.voucherid value err",
			Message: "【抵用券ID】参数值错误",
		})
		return
	}
	...
	if golibs.Length(request.Code) <= 0 {
		c.JSON(http.StatusOK, model.Response{
			Code:    "voucher.UpdateVoucherInfo.code is null",
			Message: "缺少【抵用券号】参数",
		})
		return
	}
	if !golibs.IsLetterOrNumber1(request.Code) {
		c.JSON(http.StatusOK, model.Response{
			Code:    "voucher.UpdateVoucherInfo.code format err",
	...
	if golibs.Length(request.Code) > 255 {
		c.JSON(http.StatusOK, model.Response{
			Code:    "voucher.UpdateVoucherInfo.code length err",
	...
	if request.Guestid <= 0 {
		c.JSON(http.StatusOK, model.Response{
			Code:    "voucher.UpdateVoucherInfo.guestid value err",
			Message: "【用户id】参数值错误",
		})
		return
	}
	...
	if request.Validdays <= 0 {
		c.JSON(http.StatusOK, model.Response{
			Code:    "voucher.UpdateVoucherInfo.validdays value err",
			Message: "【有效期（天）】参数值错误",
		})
		return
	}
	...
	if request.Adder <= 0 {
		c.JSON(http.StatusOK, model.Response{
			Code:    "voucher.UpdateVoucherInfo.adder value err",
			Message: "【创建人】参数值错误",
		})
		return
	}
	...
	if golibs.Length(request.Addtime) <= 0 {
		c.JSON(http.StatusOK, model.Response{
			Code:    "voucher.UpdateVoucherInfo.addtime length err",
			Message: "缺少【创建时间】参数",
		})
		return
	}
	...
	if err != nil {
		c.JSON(http.StatusOK, model.Response{
			Code:    "voucher.UpdateVoucherInfo.addtime parse err",
	...
	if request.addtimeTime.Before(time.Date(2019, 1, 1, 0, 0, 0, 0, time.Local)) {
		c.JSON(http.StatusOK, model.Response{
			Code:    "voucher.UpdateVoucherInfo.addtime value err",
	...
	if request.Moder <= 0 {
		c.JSON(http.StatusOK, model.Response{
			Code:    "voucher.UpdateVoucherInfo.moder value err",
			Message: "【修改人】参数值错误",
		})
		return
	}
	...
	if golibs.Length(request.Modtime) <= 0 {
		c.JSON(http.StatusOK, model.Response{
			Code:    "voucher.UpdateVoucherInfo.modtime length err",
			Message: "缺少【修改时间】参数",
		})
		return
	}
	...
	if err != nil {
		c.JSON(http.StatusOK, model.Response{
			Code:    "voucher.UpdateVoucherInfo.modtime parse err",
	...
	if request.modtimeTime.Before(time.Date(2019, 1, 1, 0, 0, 0, 0, time.Local)) {
		c.JSON(http.StatusOK, model.Response{
			Code:    "voucher.UpdateVoucherInfo.modtime value err",
	...
	//region 修改【抵用券管理】信息
	isSuccess, err := service.UpdateVoucherInfo(request.voucheridInt, request.Code, request.Guestid, request.Quota, request.Reduce, request.Validdays, request.Isinvalid, request.Adder, request.addtimeTime, request.Moder, request.modtimeTime)
	if err != nil {
		c.JSON(http.StatusOK, model.Response{
			Code:    "voucher.UpdateVoucherInfo.update err",
	...
	if !isSuccess {
		c.JSON(http.StatusOK, model.Response{
			Code:    "voucher.UpdateVoucherInfo.update failure",
			Message: "修改失败",
		})
		return
	}
